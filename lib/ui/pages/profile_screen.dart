...
import 'package:calori_calculator/ui/pages/meal_datail_screen.dart';
...
class _RadialProgress extends StatelessWidget {
  ...
  const _RadialProgress({this.height, this.width, this.progress});
